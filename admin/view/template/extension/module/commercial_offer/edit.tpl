        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-commercial-offer" class="form-horizontal">
                    <input type="hidden" name="commercial_offer_id" value="<?php echo $commercial_offer['id']; ?>" />
                    <div class="form-group required">
                        <label class="col-sm-2 control-label" for="commercial_offer_list_name">Название</label>
                        <div class="col-sm-10">
                          <input type="text" name="name" value="<?php echo $commercial_offer['name']; ?>" placeholder="Название" id="commercial_offer_list_name" class="form-control" />
                    ...
                    <div class="form-group">
                        ...
                        <select name="status" id="input-status" class="form-control">
                            <?php if ($commercial_offer['is_active']) { ?>
